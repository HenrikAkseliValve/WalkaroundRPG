	        ...
	        if(open==true){
	    	  ...
	    	  do{
		        if(input.isKeyPressed(KEY_ENTER)){
			      ...
			      switch(TextInput[0]){
			        case "full"         :for(int s=1;s<17;s++){
			        	                   returnPrint("Line here!");
			         			         }
			        	                 break;
			        case "getfps"       :returnPrint(GameC.getFPS());
			       	                     break;
			       	case "getmouse"     :returnPrint(Mouse.getX()+" "+ Mouse.getY());
			       		                 break;
			       	case "showentity"   :if(purenumber[0]){
			       	                     ...
			       	                     break;
			       	case "help"         :returnPrint("Commands listed below");
			        ...
			        case ""             :open=false;
			                             GameC.resume();
			                             break;
			        case "showcollision":if(!showcollideToggle){
			        	                 ...
			        	                 break;
			        default             :returnPrint("Error! No command named \""+TextInput[0]+"\" exist!");
			    			             break;
			      }
		        ...
		        if(input.isKeyPressed(KEY_NUMPAD8)){
		          if(!emptier&&up!=TextPrint.length-17){
		        	up++;
		          }
		        }
